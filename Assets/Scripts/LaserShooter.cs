...
public class LaserShooter : MonoBehaviour
{
    ...
    public float MaxLength;
      // to configure direction of lasers
    [SerializeField] Vector3 angleOffset = new Vector3(-20, 0, 0);
    ...
    void Update()
    {
        ...
        {
            Destroy(Instance);
            Instance = Instantiate(Prefabs[Prefab], FirePoint.transform.position, FirePoint.transform.rotation * Quaternion.Euler(angleOffset.x, angleOffset.y, angleOffset.z));
